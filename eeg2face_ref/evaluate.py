...
def main() -> None:
    ...
    if isinstance(saved_config, dict) and isinstance(saved_config.get("model"), dict):
        ...
        model_config = replace(
            ...
            use_sample_embedding=bool(saved_model.get("use_sample_embedding", model_config.use_sample_embedding)),
            sample_embedding_dim=int(saved_model.get("sample_embedding_dim", model_config.sample_embedding_dim)),
        )
