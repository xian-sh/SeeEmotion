...
if __name__ == '__main__':
    ...
    model = Deep4Net(n_chans=30, n_outputs=5, n_times=500,)
    out = model(sample)
...
# ├─CombinedConv: 1-3                      [32, 25, 491, 1]          19,025
# ├─BatchNorm2d: 1-4                       [32, 25, 491, 1]          50
# ├─ELU: 1-5                               [32, 25, 491, 1]          --
# ├─MaxPool2d: 1-6                         [32, 25, 163, 1]          --
# ├─Identity: 1-7                          [32, 25, 163, 1]          --
# ├─Dropout: 1-8                           [32, 25, 163, 1]          --
# ├─Conv2d: 1-9                            [32, 50, 154, 1]          12,500
# ├─BatchNorm2d: 1-10                      [32, 50, 154, 1]          100
# ├─ELU: 1-11                              [32, 50, 154, 1]          --
# ├─MaxPool2d: 1-12                        [32, 50, 51, 1]           --
# ├─Identity: 1-13                         [32, 50, 51, 1]           --
# ├─Dropout: 1-14                          [32, 50, 51, 1]           --
# ├─Conv2d: 1-15                           [32, 100, 42, 1]          50,000
# ├─BatchNorm2d: 1-16                      [32, 100, 42, 1]          200
# ├─ELU: 1-17                              [32, 100, 42, 1]          --
# ├─MaxPool2d: 1-18                        [32, 100, 14, 1]          --
# ├─Identity: 1-19                         [32, 100, 14, 1]          --
# ├─Dropout: 1-20                          [32, 100, 14, 1]          --
# ├─Conv2d: 1-21                           [32, 200, 5, 1]           200,000
# ├─BatchNorm2d: 1-22                      [32, 200, 5, 1]           400
# ├─ELU: 1-23                              [32, 200, 5, 1]           --
# ├─MaxPool2d: 1-24                        [32, 200, 1, 1]           --
# ├─Identity: 1-25                         [32, 200, 1, 1]           --
# ├─Sequential: 1-26                       [32, 5]                   --
# │    └─Conv2d: 2-1                       [32, 5, 1, 1]             1,005
# │    └─SqueezeFinalOutput: 2-2           [32, 5]                   --
# │    │    └─Rearrange: 3-1               [32, 5, 1]                --
# ==========================================================================================
# Total params: 283,280
# Trainable params: 283,280
# Non-trainable params: 0
# Total mult-adds (Units.MEGABYTES): 160.86
# ==========================================================================================
# Input size (MB): 1.92
