...
from .base_util import CausalConv1d, Ensure4d, MaxNormLinear
...
class ATCNet(EEGModuleMixin, nn.Module):
    ...
    *Role.* Efficient long-range temporal integration with stable gradients; the dilated
    ...
    def forward(self, X, return_feat=False):
        ...
        if return_feat:
            return self.out_fun(sw_concat_agg), sw_concat_agg
        else:
...
if __name__ == '__main__':
    ...
    model = ATCNet(n_chans=30, n_outputs=5, input_window_seconds=5, sfreq=100.0,)
    out = model(sample)
...
# ====================================================================================================
# ATCNet                                             [32, 5]                   --
# ├─Ensure4d: 1-1                                    [32, 30, 500, 1]          --
# ├─Rearrange: 1-2                                   [32, 1, 500, 30]          --
# ├─_ConvBlock: 1-3                                  [32, 32, 16, 1]           --
# │    └─Conv2d: 2-1                                 [32, 16, 500, 30]         816
# │    └─BatchNorm2d: 2-2                            [32, 16, 500, 30]         32
# │    └─Conv2d: 2-3                                 [32, 32, 500, 1]          960
# │    └─BatchNorm2d: 2-4                            [32, 32, 500, 1]          64
# │    └─ELU: 2-5                                    [32, 32, 500, 1]          --
# │    └─AvgPool2d: 2-6                              [32, 32, 83, 1]           --
# │    └─Dropout2d: 2-7                              [32, 32, 83, 1]           --
# │    └─Conv2d: 2-8                                 [32, 32, 83, 1]           12,288
# │    └─BatchNorm2d: 2-9                            [32, 32, 83, 1]           64
# │    └─ELU: 2-10                                   [32, 32, 83, 1]           --
# │    └─AvgPool2d: 2-11                             [32, 32, 16, 1]           --
# │    └─Dropout2d: 2-12                             [32, 32, 16, 1]           --
# ├─ModuleList: 1-13                                 --                        (recursive)
# │    └─_AttentionBlock: 2-13                       [32, 32, 13]              --
# │    │    └─Rearrange: 3-1                         [32, 13, 32]              --
# │    │    └─LayerNorm: 3-2                         [32, 13, 32]              64
# │    │    └─_MHA: 3-3                              [32, 13, 32]              2,128
# │    │    └─Dropout: 3-4                           [32, 13, 32]              --
# │    │    └─Rearrange: 3-5                         [32, 32, 13]              --
# ├─ModuleList: 1-14                                 --                        (recursive)
# │    └─Sequential: 2-14                            [32, 32, 13]              --
# │    │    └─_TCNResidualBlock: 3-6                 [32, 32, 13]              6,336
# │    │    └─_TCNResidualBlock: 3-7                 [32, 32, 13]              6,336
# ├─ModuleList: 1-15                                 --                        (recursive)
# │    └─ParametrizedMaxNormLinear: 2-15             [32, 5]                   5
# │    │    └─ModuleDict: 3-8                        --                        160
# ├─ModuleList: 1-13                                 --                        (recursive)
# │    └─_AttentionBlock: 2-16                       [32, 32, 13]              --
# │    │    └─Rearrange: 3-9                         [32, 13, 32]              --
# │    │    └─LayerNorm: 3-10                        [32, 13, 32]              64
# │    │    └─_MHA: 3-11                             [32, 13, 32]              2,128
# │    │    └─Dropout: 3-12                          [32, 13, 32]              --
# │    │    └─Rearrange: 3-13                        [32, 32, 13]              --
# ├─ModuleList: 1-14                                 --                        (recursive)
# │    └─Sequential: 2-17                            [32, 32, 13]              --
# │    │    └─_TCNResidualBlock: 3-14                [32, 32, 13]              6,336
# │    │    └─_TCNResidualBlock: 3-15                [32, 32, 13]              6,336
# ├─ModuleList: 1-15                                 --                        (recursive)
# │    └─ParametrizedMaxNormLinear: 2-18             [32, 5]                   5
# │    │    └─ModuleDict: 3-16                       --                        160
# ├─ModuleList: 1-13                                 --                        (recursive)
# │    └─_AttentionBlock: 2-19                       [32, 32, 13]              --
# │    │    └─Rearrange: 3-17                        [32, 13, 32]              --
# │    │    └─LayerNorm: 3-18                        [32, 13, 32]              64
# │    │    └─_MHA: 3-19                             [32, 13, 32]              2,128
# │    │    └─Dropout: 3-20                          [32, 13, 32]              --
# │    │    └─Rearrange: 3-21                        [32, 32, 13]              --
# ├─ModuleList: 1-14                                 --                        (recursive)
# │    └─Sequential: 2-20                            [32, 32, 13]              --
# │    │    └─_TCNResidualBlock: 3-22                [32, 32, 13]              6,336
# │    │    └─_TCNResidualBlock: 3-23                [32, 32, 13]              6,336
# ├─ModuleList: 1-15                                 --                        (recursive)
# │    └─ParametrizedMaxNormLinear: 2-21             [32, 5]                   5
# │    │    └─ModuleDict: 3-24                       --                        160
# ├─ModuleList: 1-13                                 --                        (recursive)
# │    └─_AttentionBlock: 2-22                       [32, 32, 13]              --
# │    │    └─Rearrange: 3-25                        [32, 13, 32]              --
# │    │    └─LayerNorm: 3-26                        [32, 13, 32]              64
# │    │    └─_MHA: 3-27                             [32, 13, 32]              2,128
# │    │    └─Dropout: 3-28                          [32, 13, 32]              --
# │    │    └─Rearrange: 3-29                        [32, 32, 13]              --
# ├─ModuleList: 1-14                                 --                        (recursive)
# │    └─Sequential: 2-23                            [32, 32, 13]              --
# │    │    └─_TCNResidualBlock: 3-30                [32, 32, 13]              6,336
# │    │    └─_TCNResidualBlock: 3-31                [32, 32, 13]              6,336
# ├─ModuleList: 1-15                                 --                        (recursive)
# │    └─ParametrizedMaxNormLinear: 2-24             [32, 5]                   5
# │    │    └─ModuleDict: 3-32                       --                        160
# ├─Identity: 1-16                                   [32, 5]                   --
# ====================================================================================================
# Total params: 74,340
...
# Total mult-adds (Units.MEGABYTES): 460.66
# ====================================================================================================
# Input size (MB): 1.92
# Forward/backward pass size (MB): 137.33
# Params size (MB): 0.29
# Estimated Total Size (MB): 139.55
# ====================================================================================================