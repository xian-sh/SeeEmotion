...
from .base_util import plv_time, GeneralizedGaussianFilter
...
if __name__ == '__main__':
    ...
    model = EEGMiner(n_chans=30, n_outputs=5, n_times=500,
        chs_info=chs_info,
...
# ├─GeneralizedGaussianFilter: 1-2         [32, 30, 2, 251, 2]       259
# ├─BatchNorm1d: 1-3                       [32, 870]                 --
# ├─Linear: 1-4                            [32, 5]                   4,355
# ==========================================================================================
# Total params: 4,614
