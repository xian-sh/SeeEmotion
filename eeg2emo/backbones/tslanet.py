...
# ===============================================================================================
# TSLANet                                       [32, 5]                   8,960
# ├─PatchEmbed: 1-1                             [32, 49, 128]             --
# │    └─Conv1d: 2-1                            [32, 128, 49]             76,928
# ├─Dropout: 1-2                                [32, 49, 128]             --
# ├─ModuleList: 1-3                             --                        --
# │    └─TSLANetLayer: 2-2                      [32, 49, 128]             --
# │    │    └─LayerNorm: 3-1                    [32, 49, 128]             256
# │    │    └─AdaptiveSpectralBlock: 3-2        [32, 49, 128]             513
# │    │    └─LayerNorm: 3-3                    [32, 49, 128]             256
# │    │    └─ICB: 3-4                          [32, 49, 128]             246,656
# │    │    └─Identity: 3-5                     [32, 49, 128]             --
# │    └─TSLANetLayer: 2-3                      [32, 49, 128]             --
# │    │    └─LayerNorm: 3-6                    [32, 49, 128]             256
# │    │    └─AdaptiveSpectralBlock: 3-7        [32, 49, 128]             513
# │    │    └─LayerNorm: 3-8                    [32, 49, 128]             256
# │    │    └─ICB: 3-9                          [32, 49, 128]             246,656
# │    │    └─DropPath: 3-10                    [32, 49, 128]             --
# ├─Linear: 1-4                                 [32, 5]                   645
# ===============================================================================================
# Total params: 581,895
# Trainable params: 581,895
# Non-trainable params: 0
# Total mult-adds (Units.MEGABYTES): 895.80
# ===============================================================================================
# Input size (MB): 1.92
# Forward/backward pass size (MB): 33.72
# Params size (MB): 2.29
# Estimated Total Size (MB): 37.93
# ===============================================================================================