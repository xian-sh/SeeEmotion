...
class LaBraM_EAV(nn.Module):
    ...
    '''
    def __init__(self, chunk_size=500, patch_size=100, out_chans=30, num_classes=5, embed_dim=200, depth=12,
    ...
    def forward(self, x, electrodes=[], return_patch_tokens=False, return_all_tokens=False, return_feat=False, **kwargs):
