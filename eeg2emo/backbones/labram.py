...
from .base_util import rescale_parameter, MLP, DropPath
...
if __name__ == '__main__':
    ...
    model = Labram(n_times=500, n_outputs=5, chs_info=chs_info, n_chans=30, sfreq=100.0, input_window_seconds=5,)
    out = model(sample)
...
# │    └─_SegmentPatch: 2-1                [32, 30, 2, 200]          --
# │    │    └─Rearrange: 3-1               [960, 1, 500]             --
# │    │    └─Conv1d: 3-2                  [960, 200, 2]             40,200
# ├─Sequential: 1-2                        [32, 60, 200]             40,200
# │    └─_SegmentPatch: 2-2                [32, 30, 2, 200]          (recursive)
# │    │    └─Rearrange: 3-3               [960, 1, 500]             --
# │    │    └─Conv1d: 3-4                  [960, 200, 2]             (recursive)
# │    └─_TemporalConv: 2-3                [32, 60, 200]             --
# │    │    └─Rearrange: 3-5               [32, 1, 60, 200]          --
# │    │    └─Conv2d: 3-6                  [32, 8, 60, 25]           128
# │    │    └─GroupNorm: 3-7               [32, 8, 60, 25]           16
# │    │    └─GELU: 3-8                    [32, 8, 60, 25]           --
# │    │    └─Conv2d: 3-9                  [32, 8, 60, 25]           200
# │    │    └─GroupNorm: 3-10              [32, 8, 60, 25]           16
# │    │    └─GELU: 3-11                   [32, 8, 60, 25]           --
# │    │    └─Conv2d: 3-12                 [32, 8, 60, 25]           200
# │    │    └─GroupNorm: 3-13              [32, 8, 60, 25]           16
# │    │    └─GELU: 3-14                   [32, 8, 60, 25]           --
# │    │    └─Rearrange: 3-15              [32, 60, 200]             --
# ├─Dropout: 1-3                           [32, 61, 200]             --
# ├─ModuleList: 1-4                        --                        --
# │    └─_WindowsAttentionBlock: 2-4       [32, 61, 200]             --
# │    │    └─LayerNorm: 3-16              [32, 61, 200]             400
# │    │    └─_Attention: 3-17             [32, 61, 200]             160,200
# │    │    └─Identity: 3-18               [32, 61, 200]             --
# │    │    └─LayerNorm: 3-19              [32, 61, 200]             400
# │    │    └─MLP: 3-20                    [32, 61, 200]             321,000
# │    │    └─Identity: 3-21               [32, 61, 200]             --
# │    └─_WindowsAttentionBlock: 2-5       [32, 61, 200]             --
# │    │    └─LayerNorm: 3-22              [32, 61, 200]             400
# │    │    └─_Attention: 3-23             [32, 61, 200]             160,200
# │    │    └─Identity: 3-24               [32, 61, 200]             --
# │    │    └─LayerNorm: 3-25              [32, 61, 200]             400
# │    │    └─MLP: 3-26                    [32, 61, 200]             321,000
# │    │    └─Identity: 3-27               [32, 61, 200]             --
# │    └─_WindowsAttentionBlock: 2-6       [32, 61, 200]             --
# │    │    └─LayerNorm: 3-28              [32, 61, 200]             400
# │    │    └─_Attention: 3-29             [32, 61, 200]             160,200
# │    │    └─Identity: 3-30               [32, 61, 200]             --
# │    │    └─LayerNorm: 3-31              [32, 61, 200]             400
# │    │    └─MLP: 3-32                    [32, 61, 200]             321,000
# │    │    └─Identity: 3-33               [32, 61, 200]             --
# │    └─_WindowsAttentionBlock: 2-7       [32, 61, 200]             --
# │    │    └─LayerNorm: 3-34              [32, 61, 200]             400
# │    │    └─_Attention: 3-35             [32, 61, 200]             160,200
# │    │    └─Identity: 3-36               [32, 61, 200]             --
# │    │    └─LayerNorm: 3-37              [32, 61, 200]             400
# │    │    └─MLP: 3-38                    [32, 61, 200]             321,000
# │    │    └─Identity: 3-39               [32, 61, 200]             --
# │    └─_WindowsAttentionBlock: 2-8       [32, 61, 200]             --
# │    │    └─LayerNorm: 3-40              [32, 61, 200]             400
# │    │    └─_Attention: 3-41             [32, 61, 200]             160,200
# │    │    └─Identity: 3-42               [32, 61, 200]             --
# │    │    └─LayerNorm: 3-43              [32, 61, 200]             400
# │    │    └─MLP: 3-44                    [32, 61, 200]             321,000
# │    │    └─Identity: 3-45               [32, 61, 200]             --
# │    └─_WindowsAttentionBlock: 2-9       [32, 61, 200]             --
# │    │    └─LayerNorm: 3-46              [32, 61, 200]             400
# │    │    └─_Attention: 3-47             [32, 61, 200]             160,200
# │    │    └─Identity: 3-48               [32, 61, 200]             --
# │    │    └─LayerNorm: 3-49              [32, 61, 200]             400
# │    │    └─MLP: 3-50                    [32, 61, 200]             321,000
# │    │    └─Identity: 3-51               [32, 61, 200]             --
# │    └─_WindowsAttentionBlock: 2-10      [32, 61, 200]             --
# │    │    └─LayerNorm: 3-52              [32, 61, 200]             400
# │    │    └─_Attention: 3-53             [32, 61, 200]             160,200
# │    │    └─Identity: 3-54               [32, 61, 200]             --
# │    │    └─LayerNorm: 3-55              [32, 61, 200]             400
# │    │    └─MLP: 3-56                    [32, 61, 200]             321,000
# │    │    └─Identity: 3-57               [32, 61, 200]             --
# │    └─_WindowsAttentionBlock: 2-11      [32, 61, 200]             --
# │    │    └─LayerNorm: 3-58              [32, 61, 200]             400
# │    │    └─_Attention: 3-59             [32, 61, 200]             160,200
# │    │    └─Identity: 3-60               [32, 61, 200]             --
# │    │    └─LayerNorm: 3-61              [32, 61, 200]             400
# │    │    └─MLP: 3-62                    [32, 61, 200]             321,000
# │    │    └─Identity: 3-63               [32, 61, 200]             --
# │    └─_WindowsAttentionBlock: 2-12      [32, 61, 200]             --
# │    │    └─LayerNorm: 3-64              [32, 61, 200]             400
# │    │    └─_Attention: 3-65             [32, 61, 200]             160,200
# │    │    └─Identity: 3-66               [32, 61, 200]             --
# │    │    └─LayerNorm: 3-67              [32, 61, 200]             400
# │    │    └─MLP: 3-68                    [32, 61, 200]             321,000
# │    │    └─Identity: 3-69               [32, 61, 200]             --
# │    └─_WindowsAttentionBlock: 2-13      [32, 61, 200]             --
# │    │    └─LayerNorm: 3-70              [32, 61, 200]             400
# │    │    └─_Attention: 3-71             [32, 61, 200]             160,200
# │    │    └─Identity: 3-72               [32, 61, 200]             --
# │    │    └─LayerNorm: 3-73              [32, 61, 200]             400
# │    │    └─MLP: 3-74                    [32, 61, 200]             321,000
# │    │    └─Identity: 3-75               [32, 61, 200]             --
# │    └─_WindowsAttentionBlock: 2-14      [32, 61, 200]             --
# │    │    └─LayerNorm: 3-76              [32, 61, 200]             400
# │    │    └─_Attention: 3-77             [32, 61, 200]             160,200
# │    │    └─Identity: 3-78               [32, 61, 200]             --
# │    │    └─LayerNorm: 3-79              [32, 61, 200]             400
# │    │    └─MLP: 3-80                    [32, 61, 200]             321,000
# │    │    └─Identity: 3-81               [32, 61, 200]             --
# │    └─_WindowsAttentionBlock: 2-15      [32, 61, 200]             --
# │    │    └─LayerNorm: 3-82              [32, 61, 200]             400
# │    │    └─_Attention: 3-83             [32, 61, 200]             160,200
# │    │    └─Identity: 3-84               [32, 61, 200]             --
# │    │    └─LayerNorm: 3-85              [32, 61, 200]             400
# │    │    └─MLP: 3-86                    [32, 61, 200]             321,000
# │    │    └─Identity: 3-87               [32, 61, 200]             --
# ├─Identity: 1-5                          [32, 61, 200]             --
# ├─LayerNorm: 1-6                         [32, 200]                 400
# ├─Linear: 1-7                            [32, 5]                   1,005
# ==========================================================================================
# Total params: 5,866,381
# Trainable params: 5,866,381
# Non-trainable params: 0
# Total mult-adds (Units.MEGABYTES): 318.77
# ==========================================================================================
# Input size (MB): 1.92
# Forward/backward pass size (MB): 324.46
# Params size (MB): 17.54
# Estimated Total Size (MB): 343.92
# ==========================================================================================
