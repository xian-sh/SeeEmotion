...
if __name__ == '__main__':
    ...
    model = DGCNN(in_channels=500, num_electrodes=30, hid_channels=32, num_layers=2, num_classes=5)
    out = model(sample)
...
# ==========================================================================================
# DGCNN                                    [32, 5]                   900
# ├─BatchNorm1d: 1-1                       [32, 500, 30]             1,000
# ├─Chebynet: 1-2                          [32, 30, 32]              --
# │    └─ModuleList: 2-1                   --                        --
# │    │    └─GraphConvolution: 3-1        [32, 30, 32]              16,000
# │    │    └─GraphConvolution: 3-2        [32, 30, 32]              16,000
# ├─Linear: 1-3                            [32, 64]                  --
# │    └─Linear: 2-2                       [32, 64]                  61,504
# ├─Linear: 1-4                            [32, 5]                   --
# │    └─Linear: 2-3                       [32, 5]                   325
# ==========================================================================================
# Total params: 95,729
# Trainable params: 95,729
# Non-trainable params: 0
# Total mult-adds (Units.MEGABYTES): 34.78
# ==========================================================================================
# Input size (MB): 1.92
